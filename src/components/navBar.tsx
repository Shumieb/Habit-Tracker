     ...
     <nav className="mb-3 w-[100%]">
        <div className="flex justify-between content-center w-[100%] px-2">
            ...
            <div className="p-1 flex justify-end content-center">
                <NavLink className="text-lg mx-4 p-1" to="/habit-tracker">Home</NavLink>
                <NavLink className="text-lg mx-4 p-1" to="/habit-tracker/goals">Goals</NavLink>
